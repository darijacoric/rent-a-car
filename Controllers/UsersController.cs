...
namespace RentACar.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                // todo: Change this part so that query is not executed to fetch roles from db, instead retrieve all roles and userroles.                
                user.RoleNames = GetRoleNamesForUser(user.Id);
            }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    var user = new AppUser
                    {
                        ...
                        AccountStatus = UserStatus.Enabled
                    };
        ...
        private string[] GetRoleNamesForUser(int userId)
        {
