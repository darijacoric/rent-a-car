...
namespace RentACar
{
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<AppUser, int>(dataProtectionProvider.Create("RentACar Identity"));
            }
            return manager;
        }
    }
    ...
    public class ApplicationSignInManager : SignInManager<AppUser, int>
    {
        ...
        public override Task<SignInStatus> PasswordSignInAsync(string userName, string password, bool isPersistent, bool shouldLockout)
        {
            ...
            if (user != null)
            {
                // If user's AccountStatus value is Disabled or doesn't have value then return LockedOutStatus
                if ((user.AccountStatus.HasValue && user.AccountStatus.Value == UserStatus.Disabled) || !user.AccountStatus.HasValue)
                {
